...
export const metadata: Metadata = {
  title: "Privacy Policy | MagicStocks.ai - Future of Stock Analysis",
  description:
    "Read our Privacy Policy to understand how MagicStocks.ai collects, uses, and protects your personal data. We prioritize your privacy in all AI stock analysis interactions.",
};

const PrivacyPage = () => {
  return (
    <section>
      <h1 className="text-6xl font-bold m-6 text-center">Privacy Policy</h1>
      <div className="max-w-4xl mx-auto p-6 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-200 rounded-md shadow-md">
        <div className="prose dark:prose-dark max-w-none">
          ...
          <p className="mb-2">
            We may collect personal information that can identify you, such as:
          </p>
          ...
          <p className="mb-2">
            ...
            and used, including but not limited to:
          </p>
          <ul className="list-disc ml-6 mb-4">
            <li>IP address</li>
            <li>Browser type</li>
          ...
          <p className="mb-4">We use your personal and usage information to:</p>
          <ul className="list-disc ml-6 mt-2">
            <li>Operate, maintain, and improve the MagicStocks.ai platform.</li>
            <li>
              Provide personalized stock market analysis and AI-driven insights.
            </li>
            <li>
          ...
          <p className="mb-4">
            ...
            our Service (e.g., data hosting, analytics, customer support). These
          ...
          <ul className="list-disc ml-6 mt-2">
            ...
            <li>
              Protect and defend the rights or property of MagicStocks.ai.
            </li>
            <li>
          ...
          <p className="mb-4">
            ...
            technical, and physical measures to protect your personal
          ...
          <p className="mb-4">
            ...
            account or request deletion, we will delete your personal data
